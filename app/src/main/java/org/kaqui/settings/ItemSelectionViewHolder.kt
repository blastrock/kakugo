...
class ItemSelectionViewHolder(private val dbView: LearningDbView, v: View, private val statsFragment: StatsFragment) : androidx.recyclerview.widget.RecyclerView.ViewHolder(v) {
